...
import { ArrowLeft, Package, Scan, CheckCircle, Clock } from 'lucide-react';
      ...
      >
        ...
        >
          <TraceTimeline batchId={batchId} />
              ...
              <h2 className="card-title text-xl">Batch Information</h2>
              <p className="text-base-content/70">Batch ID: {batchId}</p>
            </div>
            <div className="text-right">
              <div className="badge badge-success">Verified</div>
              <p className="text-xs text-base-content/60 mt-1">Last updated: 2 hours ago</p>
            </div>
          </div>
        </div>
      </motion.div>
